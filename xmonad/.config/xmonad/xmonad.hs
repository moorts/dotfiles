...
--
myLayout = tiled ||| simpleTabBar (tiled) ||| Mirror tiled ||| Full
  where
...
myStartupHook host = do
    ...
    spawn "setxkbmap -option grp:alt_shift_toggle -option ctrl:nocaps"
...
myPP =
    xmobarPP
        { ppHiddenNoWindows = xmobarColor "white" hiddenBg . wrap " " " "
